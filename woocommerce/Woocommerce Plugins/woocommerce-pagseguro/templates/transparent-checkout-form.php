...
$("#pagseguro-payment-method-credit-card").attr("checked", false);

$("#pagseguro-payment-method-credit-card").click(function() {

	
	$(".pagseguro-method-form").hide();	
	  $("#pagseguro-credit-card-form").show( "fast" );

	});


$("#pagseguro-payment-method-bank-transfer").click(function() {

	$(".pagseguro-method-form").hide();	
	
	   $("#pagseguro-bank-transfer-form").show( "fast" );

	});


$("#pagseguro-payment-method-banking-ticket").click(function() {

	$(".pagseguro-method-form").hide();	
	
	   $("#pagseguro-banking-ticket-form").show( "fast" );
