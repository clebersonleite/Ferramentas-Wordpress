...
class Woo_Payment_Discounts_Admin {
    ...
    public function wpd_admin_menu() {
        add_submenu_page(
                'woocommerce', __('Discount Per Payment method for WooCommerce', 'woo-payment-discounts'), __('Discount Per Payment', 'woo-payment-discounts'), 'manage_woocommerce', 'woo-payment-discounts', array($this, 'plugin_admin_page_callback')
        );
    }
    ...
    public function wpd_screen_pages() {
        add_dashboard_page(
                'Welcome To Discounts Per Payment Method for WooCommerce', 'Discounts Per Payment Method for WooCommerce', 'read', 'wpd-about', array($this, 'wpd_screen_content'));
    }
        ...
        <div class="wrap wpd_welcome_wrap">
            <fieldset>
                ...
                <div class="wpd_welcom_div">
                    ...
                    <a href="https://codecanyon.net/item/woocommerce-advanced-discounts-and-fees/19009855?s_rank=1" target="_blank"><h4> Download WooCommerce Advanced Discounts and Fees Plugin</h4></a>
            </fieldset>
        </div>
