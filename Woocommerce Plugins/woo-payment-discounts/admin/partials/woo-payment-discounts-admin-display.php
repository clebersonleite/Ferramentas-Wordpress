            ...
            <tbody>
                ...
                foreach ($payment_gateways as $gateway) :
                    ...
                    <tr valign="top">
                        ...
                        <td><input type="text" class="input-text regular-input" value="<?php echo esc_attr($current); ?>" id="woo_payment_discounts_<?php echo esc_attr($gateway->id); ?>" name="woo_payment_discounts[<?php echo esc_attr($gateway->id); ?>][amount]" /></td>
                        <td>
                            <select id="woo_payment_discounts_type" name="woo_payment_discounts[<?php echo esc_attr($gateway->id); ?>][type]">
                                <option value="fixed" <?php if (isset($getsettings[$gateway->id]['type']) && $getsettings[$gateway->id]['type'] == "fixed") echo 'selected="selected"'; ?> >Fixed</option>
                                <option value="percentage" <?php if (isset($getsettings[$gateway->id]['type']) && $getsettings[$gateway->id]['type'] == "percentage") echo 'selected="selected"'; ?> >Percentage(%)</option>
                            </select>  
